...
Wallet management, smart contract interaction, token swaps, and DeFi analytics across Ethereum,
Polygon, Arbitrum, Optimism, Base, and Solana.
...
- `network` (enum, default: "ethereum") — Network: ethereum, polygon, arbitrum, optimism, base,
  solana
